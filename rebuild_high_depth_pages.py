...
def generate_page(s, schemes_list):
    ...
    toc_html = """            <div class="toc">
              ...
              <ol>
                <li><a href="#overview">Scheme Overview &amp; Background</a></li>
                <li><a href="#objectives">Core Objectives &amp; Strategic Mandate</a></li>
                <li><a href="#benefits">Benefits &amp; Financial Coverage</a></li>
                <li><a href="#eligibility">Eligibility Criteria</a></li>
                <li><a href="#exclusions">Exclusion &amp; Ineligibility List</a></li>
                <li><a href="#documents">Mandatory Documents Checklist</a></li>
                <li><a href="#apply">Step-by-Step Application Process</a></li>
                <li><a href="#status">Application Status Tracking</a></li>
                <li><a href="#helpline">Grievance Redressal &amp; Helpdesk</a></li>
...
{toc_html}
            ...
            <h2 id="overview">Scheme Overview &amp; Background</h2>
            <p>{overview_text}</p>

            <h2 id="objectives">Core Objectives &amp; Strategic Mandate</h2>
            <p>The primary objective of <strong>{fullname}</strong> is to establish a sustainable, transparent, and accessible welfare support mechanism for eligible citizens in the <strong>{cat_info['name']}</strong> sector across all Indian States and Union Territories. Key policy goals include:</p>
            <ul>
              <li><strong>Targeted Financial &amp; Physical Support:</strong> Eliminating economic hardship by ensuring benefits reach verified beneficiaries directly without administrative delays or intermediary leakage.</li>
              <li><strong>Inclusive Coverage &amp; Equity:</strong> Prioritizing marginalized, small-holder, rural, and economically weaker section households to promote balanced socio-economic growth.</li>
              <li><strong>Digital Transparency &amp; Governance:</strong> Utilizing Direct Benefit Transfer (DBT), Aadhaar-seeded verification, and portal tracking to ensure full accountability.</li>
              <li><strong>Long-term Empowerment:</strong> Fostering self-reliance, financial stability, and improved quality of life for target beneficiary communities.</li>
              <li><strong>Social &amp; Economic Security Net:</strong> Strengthening grassroots socio-economic resilience by providing dependable state assistance during times of financial distress or structural transition.</li>
              <li><strong>Capacity Building &amp; Infrastructure Development:</strong> Enhancing community-level access to essential civic services, banking networks, and agricultural productivity resources.</li>
            </ul>
            <p>Under the administrative supervision of the respective central ministry and state implementing departments, <strong>{fullname}</strong> operates through standardized operational guidelines. Periodic impact evaluations and social audits are conducted to review benefit disbursal efficiency, verify beneficiary satisfaction, and refine administrative workflows.</p>

            <h2 id="benefits">Benefits &amp; Financial Coverage</h2>
            <p>{benefits_text}</p>
{table_html}
...
{eligibility_html}
            ...
            <h2 id="exclusions">Exclusion &amp; Ineligibility List</h2>
{exclusions_html}

            <h2 id="documents">Mandatory Documents Checklist</h2>
{documents_html}

            <h2 id="apply">Step-by-Step Application Process</h2>
{apply_html}

            <h2 id="status">Application Status Tracking</h2>
{status_html}

            <h2 id="helpline">Grievance Redressal &amp; Helpdesk Assistance</h2>
            <p>If you encounter difficulties during online application submission, Aadhaar bank seeding, or installment tracking for <strong>{fullname}</strong>, the Government of India provides multi-tier assistance channels:</p>
            <ul>
              <li><strong>Official Scheme Helpline:</strong> Visit the official portal at <a href="{portal}" target="_blank" rel="noopener noreferrer">{portal.replace("https://", "").replace("http://", "")}</a> to access verified toll-free helpdesk phone numbers and email contacts.</li>
              <li><strong>Centralized Public Grievance Redress and Monitoring System (CPGRAMS):</strong> File formal grievances online at <a href="https://pgportal.gov.in" target="_blank" rel="noopener noreferrer">pgportal.gov.in</a> under the respective Nodal Ministry.</li>
              <li><strong>District &amp; Local Nodal Officers:</strong> Contact your local Block Development Office (BDO), District Magistrate (DM) office, or Village Panchayat Secretariat for offline assistance.</li>
            </ul>
